...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-[350] bg-black/70 backdrop-blur-[2px]',
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-lg',
        'bg-[var(--surface)] border border-white/[0.08]',
        'p-8',
        'shadow-xl',
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex justify-end gap-3 mt-6 pt-6 border-t border-white/[0.08]', className)} {...props} />
)
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-heading font-bold uppercase tracking-widest text-sm text-white', className)}
    {...props}
  />
))
